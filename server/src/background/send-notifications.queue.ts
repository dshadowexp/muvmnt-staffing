...
export class SendNotificationsQueue extends BaseQueue<NotificationJobData, NotificationJobName> {
...
const sendNotificationsBackground = new SendNotificationsQueue();

export function getSendNotificationsQueue() {
    return sendNotificationsBackground;
}