...
export function PricingClient() {
  ...
  const factors = t.raw("staffing.factors") as Array<{
    icon: string;
    label: string;
    detail: string;
  }>;
  const staffTiers = t.raw("staffing.tiers") as Array<{
    key: string;
    name: string;
    tagline: string;
    detail: string;
  }>;
  const billingSteps = t.raw("staffing.steps") as Array<{
    num: string;
    label: string;
    detail: string;
  }>;
