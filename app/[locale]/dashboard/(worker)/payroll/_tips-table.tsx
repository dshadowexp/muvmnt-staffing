...
export function TipsTable({ tips }: { tips: WorkerTipRow[] }) {
  const pagination = useTablePagination(tips);
  const rows = pagination.rows;

  if (tips.length === 0) {
    return <p className="text-muted-foreground text-sm">No tips yet.</p>;
  }
