...
function appCurrentPageLabel(pathname: string, isClient: boolean): string {
  ...
  if (path.startsWith("/app/job-infos")) return "Job postings";
  return "App";
}
...
export function NavbarUserMenu({
  ...
  const onAvailability = pathname.startsWith("/app/availability");
  const onPayroll = pathname.startsWith("/app/payroll");
