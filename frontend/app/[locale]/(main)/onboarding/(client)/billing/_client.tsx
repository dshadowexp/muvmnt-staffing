...
import getStripeClient, { DARK_APPEARANCE, LIGHT_APPEARANCE } from "@/services/stripe/client";
...
export function BillingClient({ initialPaymentMethods }: { initialPaymentMethods?: CardSummary[] }) {
    ...
    const [serverErrors, action] = useActionState(billingAction, initialState);
