...
function RoleBadge({ role }: { role: FacilityRole }) {
  return (
    <Badge
      variant="outline"
...
function InviteModal({
  ...
  const [role, setRole] = useState<FacilityRole>("member");
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Select value={role} onValueChange={(v) => setRole(v as FacilityRole)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                      ...
                      {pendingInvites.map((invite) => {
                        ...
                        return (
                          <tr key={invite.id}>
                            ...
                            <td className="px-4 py-3 w-28">
                              <RoleBadge role={invite.permission as FacilityRole} />
                            </td>
                            <td className="px-4 py-3 w-12 text-right">
                              <Button
                                type="button"
