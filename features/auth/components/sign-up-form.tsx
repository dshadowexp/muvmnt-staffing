...
export function SignUpForm() {
  ...
  const handleRoleSelect = (r: UserRole) => {
    setRole(r);
    setPendingRole(r);
    posthog.capture("onboarding_role_selected", { role: r });
  ...
  async function handleSubmit(data: SignUpValues) {
    try {
      ...
      posthog.identify(data.email.trim(), { email: data.email.trim(), role: role ?? undefined });
      posthog.capture("user_signed_up", { method: "email", role: role ?? undefined, has_referral: !!referralCode });
