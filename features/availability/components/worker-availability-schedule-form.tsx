...
import { Copy, Globe, Info, Plus, Trash2, Zap } from "lucide-react";
        ...
        <Card className="border-border/80 h-full">
          <CardContent className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    type="button"
                    className="text-muted-foreground hover:text-foreground inline-flex shrink-0 rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    aria-label={t("autoConfirmInfoAria")}
                  >
            ...
            <Select
              ...
              onValueChange={(v) => setAutoConfirm(v === "true")}
            >
              <SelectTrigger id="auto-confirm" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="true">{t("autoConfirmYes")}</SelectItem>
                <SelectItem value="false">{t("autoConfirmNo")}</SelectItem>
              </SelectContent>
            </Select>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            {DAY_ORDER.map((d) => {
              ...
              return (
                ...
                >
                  <div className="flex w-full min-w-[140px] items-center gap-3 @lg:w-[180px]">
                    <Switch
                      checked={day.enabled}
